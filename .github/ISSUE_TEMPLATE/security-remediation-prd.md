---
name: 安全与工程整改 PRD（v1.0）
about: 全仓库审计整改跟踪 — 3 P0 / 4 P1 / 5 P2，基于 2026-08-17 代码审计
title: "[整改] 安全与工程整改 PRD v1.0 — P0×3 / P1×4 / P2×5"
---

> ⚠️ **安全提示**：本 PRD 所涉历史泄露密钥已吊销轮换；文档本身不含任何真实密钥值，请勿尝试从 git 历史检索或利用。
