module.exports = {
  ...
  collectCoverageFrom: ['js/ai/ai-client.js', 'js/core/utils.js'],
  ...
  coverageThreshold: {
    ...
    './js/ai/ai-client.js': { statements: 15, branches: 7, functions: 20, lines: 18 },
    './js/core/utils.js': { statements: 6, branches: 5, functions: 3, lines: 7 }
  }
};
