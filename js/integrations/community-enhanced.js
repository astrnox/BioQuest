...
(function () {
  ...
  function loadQuikchat() {
    ...
    return window.loadScriptOnce('js/vendor/quikchat.umd.min.js?v=' + V, {
      verify: function () { return typeof window.quikchat === 'function'; }
    }).then(function () {
  ...
  // 暴露到全局
  /**
   * 社区模块增强接口，基于 quikchat 提供实时讨论区的挂载/卸载、加载状态查询与页面渲染能力。
   * @type {Object}
   */
